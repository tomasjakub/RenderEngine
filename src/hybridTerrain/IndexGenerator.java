...
public class IndexGenerator {
	...
	private static int storeLastRowQuad(int topLeft, int topRight, int bottomLeft, int bottomRight, int[] indices,
			int pointer, boolean rightHanded) {
		pointer = storeLeftTriangle(topLeft, topRight, bottomLeft, bottomRight, indices, pointer, rightHanded);
		indices[pointer++] = bottomRight;
		indices[pointer++] = topRight;
		indices[pointer++] = rightHanded ? topLeft : bottomLeft;
	...
	private static int storeLeftTriangle(int topLeft, int topRight, int bottomLeft, int bottomRight, int[] indices,
			int pointer, boolean rightHanded) {
